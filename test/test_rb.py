...
def test_shared_storage_prioritized_sampler():
    ...
    rb0 = rb_prototype.ReplayBuffer(storage=storage, writer=writer, sampler=sampler0, collate_fn=lambda x: x)
    rb1 = rb_prototype.ReplayBuffer(storage=storage, writer=writer, sampler=sampler1, collate_fn=lambda x: x)
...
def test_legacy_rb_does_not_attach():
    ...
    prb = rb_prototype.ReplayBuffer(storage=storage, writer=writer, sampler=sampler, collate_fn=lambda x: x)
